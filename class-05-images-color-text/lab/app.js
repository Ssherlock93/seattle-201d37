...
function multiply(a, b) { //eslint-disable-line
    var product = a * b;
    var message = [product, 'The product of ' + a + ' and ' + b + ' is '+ product + '.'];
    return message;
    }
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    var sumTemp = sum(a, b);
    var sumTotal = sum(sumTemp[0], c);
    var productTemp = multiply(a, b);
    var productTotal = multiply(productTemp[0], c);
    var arr = [];
    arr.push(sumTotal[0]);
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var sumTotal = sum(sum1[0], sumArr[2]);
  var message = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sumTotal[0] + ' is their sum.';
  var arr = [sumTotal[0], message];
  return arr;
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var productTotal = multiply(product1[0], multArr[2]);
  var message = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + productTotal[0] + '.';
  var arr = [productTotal[0], message];
  return arr;
